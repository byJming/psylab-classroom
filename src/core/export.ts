...
export function codebookCsv(definition: ExperimentDefinition): string {
  const specificFields: Record<string, Array<Record<string, unknown>>> = {
    ...
    "posner-cueing": [{ field: "data.cueType", description: "空间线索有效性", unit: "", allowed: "valid|invalid|neutral", version: "1.0" }, { field: "data.cuePosition", description: "线索方向", unit: "", allowed: "left|right|neutral", version: "1.0" }, { field: "data.position", description: "目标位置", unit: "", allowed: "left|right", version: "1.0" }, { field: "data.cueMs", description: "线索呈现时长", unit: "ms", allowed: "integer", version: "1.0" }],
    "signal-detection": [{ field: "data.signalPresent", description: "程序化信号是否存在", unit: "", allowed: "boolean", version: "1.0" }],
    "n-back": [{ field: "data.n", description: "当前区块的回溯步数", unit: "item", allowed: "1|2", version: "1.1" }, { field: "data.blockIndex", description: "当前负荷区块顺序", unit: "index", allowed: "integer", version: "1.1" }, { field: "data.letter", description: "当前字母", unit: "", allowed: "B|C|F|H|K|L|P|R|T|Y", version: "1.1" }, { field: "data.match", description: "当前字母是否匹配 n 步之前", unit: "", allowed: "boolean", version: "1.1" }, { field: "data.ruleCue", description: "该试次前是否显示区块规则提示", unit: "", allowed: "boolean", version: "1.1" }, { field: "data.leadInLetters", description: "区块开始时仅用于建立参照的准备字母，使用竖线分隔且不计入指标", unit: "", allowed: "letters separated by | or empty", version: "1.1" }],
    "task-switching": [{ field: "data.rule", description: "当前判断规则", unit: "", allowed: "color|shape", version: "1.0" }, { field: "data.switchType", description: "当前试次相对前一规则的类型", unit: "", allowed: "repeat|switch", version: "1.0" }, { field: "data.colorName", description: "图形颜色", unit: "", allowed: "red|blue", version: "1.0" }, { field: "data.shape", description: "图形形状", unit: "", allowed: "circle|square", version: "1.0" }]
  };
  const conditionAllowed: Record<string, string> = { "stroop-color-word": "congruent|incongruent", flanker: "congruent|incongruent", "choice-rt": "set-2|set-4", simon: "compatible|incompatible", "visual-search": "feature-4|feature-8|conjunction-4|conjunction-8", "posner-cueing": "valid|invalid|neutral", "signal-detection": "signal|noise", "n-back": "1-back|2-back", "task-switching": "repeat|switch" };
  const rows = [
